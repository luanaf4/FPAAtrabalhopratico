...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // int[] set1 = new
        // int[]{40,36,38,29,32,28,31,35,31,30,32,30,29,39,35,38,39,35,32,38,32,33,29,33,29,39,28};
        // int[] set2 = new
        // int[]{32,51,32,43,42,30,42,51,43,51,29,25,27,32,29,55,43,29,32,44,55,29,53,30,24,27};
        ...
        for (int x = 1; x <= 10; x++) {
            ...
            List<int[]> routesSet = GeradorDeProblemas.geracaoDeRotas(routesQuantity * x, setLength, 0.5);
            ...
            for (int y = 0; y < 10; y++) {
                ...
                for (int[] routes : routesSet) {
                    ...
                    List<Integer> routesAsList = new ArrayList<Integer>(
                            Arrays.asList(Arrays.stream(routes).boxed().toArray(Integer[]::new)));
            ...
            System.out.println("Tempo médio de execução com " + x + "T: " + totalTime * 1000000 + "ns");
